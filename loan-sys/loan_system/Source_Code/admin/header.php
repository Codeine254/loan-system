...
<div class="sidebar-menu">
    <div class="sidebar-header">
        <div class="logo">
            <a href="index.php" style="color:white">Developed by <b>Mayuri K.</b> </a>
        </div>
    </div>
    <div class="main-menu">
...
<span class="pcoded-mtext">Payment History</span>
 ...
 <li><a href="about_author.php"><span class="ti-face-smile"></span> About Author</a></li>
</li>
                </ul>
            </nav>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Welcome Mayuri K. ! <i class="fa fa-angle-down"></i></h4>
